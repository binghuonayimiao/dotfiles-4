...
() {
  ...
  # ypeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR=' '
  ...
  #typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='\u'
  # Separator between same-color segments on the right.
  #typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='\u'
  # Separator between different-color segments on the left.
  # typeset -g POWERLEVEL9K_LEFT_SEGMENT_SEPARATOR='\uE0B0'
  # Separator between different-color segments on the right.
  # typeset -g POWERLEVEL9K_RIGHT_SEGMENT_SEPARATOR='\uE0B2'
  # The right end of left prompt.
  #typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='\u'
  # The left end of right prompt.
  #typeset -g POWERLEVEL9K_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL='\u'
  ...
  #
      # Styling for WORK.
      typeset -g POWERLEVEL9K_DIR_WORK_VISUAL_IDENTIFIER_EXPANSION='[WS]'
  ...
  #
      ...
      typeset -g POWERLEVEL9K_DIR_WORK_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION='[R/W]-Issue'
  ...
  #
      ...
      typeset -g POWERLEVEL9K_DIR_WORK_NON_EXISTENT_VISUAL_IDENTIFIER_EXPANSION='[x]'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local conflicted='%39F'   # blue foreground
    else
    ...
    if (( VCS_STATUS_NUM_CONFLICTED || VCS_STATUS_NUM_STAGED || VCS_STATUS_NUM_UNSTAGED || VCS_STATUS_NUM_UNTRACKED )); then
        typeset -g my_git_format="${1+%B%4F}($res${1+%B%3F} ✗${1+%B%4F})"
    else
        typeset -g my_git_format="${1+%B%4F}($res${1+%B%76F} ✔${1+%B%4F})"
    fi
  }
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_VCS_PREFIX='%B%39Fgit:'
  ...
  # it'll hide python version in this case because 3.8.1 is the same as the Qevglobal version.
  ...
  #
  # The default format:
  # zshNT:+"!$P9K_TASKWARRIOR_OVERDUE_COUNT/"}$P9K_TASKWARRIOR_PENDING_COUNT'
  #
